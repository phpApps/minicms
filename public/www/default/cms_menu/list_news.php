...
<title><?php echo $row_menu['menu_title'] ? $row_menu['menu_title'] : $row_menu['menu_name'];?></title>
<meta name="keywords" content="<?php echo config_item('menu_keyword');?>" />
<meta name="description" content="<?php echo config_item('menu_description');?>" />
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item pb30 pt30">
              <h4 class="list-group-item-heading"><a href="<?php echo site_url('news/'.$art['art_id']);?>"><?php echo $art['art_title']?></a>
                <div class="mt10"><small>分类：<?php echo $row_menu['menu_name'];?></small>&nbsp;&nbsp;<small><?php echo $art['art_addtime']?></small></div>
              </h4>
              <div class="mt10 list-group-item-text"><?php echo ellipsize($art['art_description'],200)?></div>
            </li>
            <?php endforeach;?>
          </ul>
