      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <ul class="media-list">
            ...
            <li class="media"> <a class="pull-left"><img class="media-object " src="<?php echo $art['art_attach'] ? base_url($art['art_attach']) : base_url('default/assets/images/default.jpg');?>"></a>
              <div class="media-body">
                <h4 class="media-heading"><a href="<?php echo site_url('image/'.$art['art_id']);?>"><?php echo $art['art_title']?></a></h4>
                <p><?php echo ellipsize($art['art_description'],200)?></p>
              </div>
            </li>
            <?php endforeach;?>
          </ul>
