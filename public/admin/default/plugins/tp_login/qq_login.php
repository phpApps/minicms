  ...
  <table cellspacing="0" cellpadding="0" width="100%" class="formBox" align="left">
    ...
    <tr>
     ...
     <tr>
      ...
      <tr>
        <td></td>
        <td><button type="submit">创建配置</button>&nbsp;&nbsp; <a target="_blank" href="<?php echo site_url("admin/plugin/qq_login?redirect_uri=".base64_encode(current_url()));?>">测试</a>（测试前先创建配置）</td>
      </tr>
      <tr>
         <td colspan="2">
          <b class="red">*</b> 注意：<br/>
          1.接口使用方法：域名/amin/plugin/qq_login?redirect_uri={回调地址}，回调地址采用 base64_encode 加密处理。<br/>
          2.必须在www环境下使用。<br/>
          详情见说明。
         </td>
      </tr>
