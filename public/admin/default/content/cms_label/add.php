...
<div class="toolBox">
  <button type="button" onclick="location.href='<?php echo site_url("cms_label/index/$label_bs");?>'">返回</button>
</div>
...
<form method="post">
    ...
    <tbody>
      <tr>
        ...
        <td><select name="label_enable" class="ws50">
            <option value="1" <?php echo set_select('label_enable',1);?>>显示</option>
            <option value="0" <?php echo set_select('label_enable',0);?>>隐藏</option>
          </select>
          <?php echo form_error('label_count');?></td>
      </tr>
      <tr>
        <td>排序</td>
        <td><input type="text" name="label_sort" value="<?php echo set_value('label_sort',100); ?>" class="ws50" />
          <?php echo form_error('label_sort');?></td>
      </tr>
      <tr>
        <td>名称<span class="red">*</span></td>
        <td><input type="text" name="label_name" value="<?php echo set_value('label_name'); ?>" class="ws50" />
          <?php echo form_error('label_name');?></td>
      </tr>
      <tr>
        <td>URL</td>
        <td><input type="text" name="label_url" value="<?php echo set_value('label_url'); ?>" class="ws50" />
          <?php echo form_error('label_url');?></td>
      </tr>
      <tr>
        <td>简介</td>
        <td><textarea name="label_intro" class="ws50"><?php echo set_value('label_intro'); ?></textarea>
  ...
  <table width="50%" cellspacing="0" class="formBox" align="right">
    <tbody class="notout">
      <tr>
        <td>附件图片</td>
        <td><input type="text" id="label_attach" name="label_attach" value="<?php echo set_value('label_attach'); ?>" class="ws50" readonly="readonly" />
          <input type="button" id="uploadButton" value="Upload" />
          <?php echo form_error('label_attach');?></td>
      </tr>
      <tr>
        <td>附件图片</td>
        <td><input type="text" id="label_attach2" name="label_attach2" value="<?php echo set_value('label_attach2'); ?>" class="ws50" readonly="readonly" />
          <input type="button" id="uploadButton2" value="Upload" />
          <?php echo form_error('label_attach2');?></td>
      </tr>
      <tr>
        <td>附件文件</td>
        <td><input type="text" id="label_attach3" name="label_attach3" value="<?php echo set_value('label_attach3'); ?>" class="ws50" readonly="readonly" />
          <input type="button" id="uploadButton3" value="Upload" />
          <?php echo form_error('label_attach3');?></td>
      </tr>
      <tr>
        <td>meta标题</td>
        <td><input type="text" name="label_title" value="<?php echo set_value('label_title'); ?>" class="ws50"/>
          <?php echo form_error('label_title');?></td>
      </tr>
      <tr>
        <td>meta关键字</td>
        <td><textarea name="label_keyword" class="ws50"><?php echo set_value('label_keyword'); ?></textarea>
          <?php echo form_error('label_keyword'); ?></td>
      </tr>
      <tr>
        <td>meta描述</td>
        <td><textarea name="label_description" class="ws50"><?php echo set_value('label_description'); ?></textarea>
