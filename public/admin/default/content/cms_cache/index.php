...
<form method="post">
  <table width="100%" cellspacing="0" cellpadding="5" class="formBox">
    <tbody>
      <tr>
        <td>站点配置</td>
        <td><input type="checkbox" name="cache_model[]" checked="checked" value="update_cms_setting_cache" /></td>
      </tr>
      <tr>
        <td>菜单列表</td>
        <td><input type="checkbox" name="cache_model[]" checked="checked" value="update_cms_menu_cache" /></td>
      </tr>
      <tr>
        <td>菜单路由</td>
        <td><input type="checkbox" name="cache_model[]" checked="checked" value="update_cms_route_cache" /></td>
      </tr>
      <tr>
        <td></td>
