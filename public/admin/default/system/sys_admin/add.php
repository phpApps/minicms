...
<form method="post">
  <table cellspacing="0" cellpadding="0" width="50%" class="formBox" align="left">
    ...
    <tr>
        ...
        <td><input type="text" name="admin_login" value="<?php echo set_value('admin_login');?>" class="ws50" />
          <?php echo form_error('admin_login');?></td>
      </tr>
      <tr>
        <td>手机<span class="red">*</span></td>
        <td><input type="text" name="admin_phone" value="<?php echo set_value('admin_phone');?>" class="ws50" />
      ...
      <tr>
        ...
        <td><select name="admin_roleid" class="ws50">
            ...
            <option value="<?php echo $role['role_id'];?>" <?php echo set_select('admin_roleid',$role['role_id']);?>><?php echo $role['role_name'];?></option>
            <?php endforeach;?>
          </select>
      ...
      <tr>
        ...
        <td><select name="admin_work" class="ws50">
            <option value="1" <?php echo set_select('admin_work',1);?>>在职</option>
            <option value="0" <?php echo set_select('admin_work',0);?>>离职</option>
          </select>
  ...
  <table cellspacing="0" cellpadding="0" width="50%" class="formBox" align="right">
    <tbody>
      <tr>
        ...
        <td><input type="text" name="admin_name" value="<?php echo set_value('admin_name');?>" class="ws50" />
          <?php echo form_error('admin_name');?></td>
      </tr>
      <tr>
        <td>性别<span class="red">*</span></td>
        <td><select name="admin_sex" class="ws50">
            <option value="男" <?php echo set_select('admin_sex','男');?>>男</option>
            <option value="女" <?php echo set_select('admin_sex','女');?>>女</option>
          </select>
          <?php echo form_error('admin_sex');?></td>
      </tr>
      <tr>
        <td>生日</td>
        <td><input type="text" name="admin_birth" value="<?php echo set_value('admin_birth');?>" class="ws50" />
          <?php echo form_error('admin_birth');?></td>
      </tr>
      <tr>
        <td>电邮</td>
        <td><input type="text" name="admin_email" value="<?php echo set_value('admin_email');?>" class="ws50" />
          <?php echo form_error('admin_email');?></td>
      </tr>
      <tr>
        <td>地址</td>
        <td><textarea name="admin_address" class="ws50"><?php echo set_value('admin_address');?></textarea>
