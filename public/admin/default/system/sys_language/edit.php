...
<form method="post">
  <table width="100%" cellspacing="0" class="formBox">
    <tbody>
      <tr>
        <td>ID</td>
        <td><input type="text" disabled="disabled" value="<?php echo $row['lang_id']; ?>" class="ws50" /></td>
      </tr>
      <tr>
        <td>启用</td>
        <td><select name="lang_enable" class="ws50">
            <option value="1" <?php echo set_select('lang_enable',1,$row['lang_enable']==1?TRUE:FALSE);?>>是</option>
            <option value="0" <?php echo set_select('lang_enable',0,$row['lang_enable']==0?TRUE:FALSE);?>>否</option>
          </select>
      ...
      <tr>
        ...
        <td><select name="lang_default" class="ws50">
            <option value="0" <?php echo set_select('lang_default',0,$row['lang_default']==0?TRUE:FALSE);?>>否</option>
            <option value="1" <?php echo set_select('lang_default',1,$row['lang_default']==1?TRUE:FALSE);?>>是</option>
          </select>
          <?php echo form_error('lang_default');?></td>
      </tr>
      <tr>
        <td>标识<span class="red">*</span></td>
        <td><input type="text" name="lang_sign" value="<?php echo set_value('lang_sign',$row['lang_sign']); ?>" class="ws50" />
          <?php echo form_error('lang_sign');?></td>
      </tr>
      <tr>
        <td>名称<span class="red">*</span></td>
        <td><input type="text" name="lang_name" value="<?php echo set_value('lang_name',$row['lang_name']); ?>" class="ws50"/>
