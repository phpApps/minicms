    ...
    <tbody>
      <tr>
        ...
        <td><select name="option_pid" class="ws50">
            ...
            <?php echo $this->sys_option_model->select_option(set_value('option_pid'));?>
          </select>
          <?php echo form_error('option_pid');?></td>
      </tr>
      <tr>
        <td>名称<span class="red">*</span></td>
        <td><input type="text" name="option_name" value="<?php echo set_value('option_name'); ?>" class="ws50" />
          <?php echo form_error('option_name');?></td>
      </tr>
      <tr>
        <td>文件夹名<span class="red">*</span></td>
        <td><input type="text" name="option_folder" class="ws50"/>（项目文件夹名 <i class="red">注意：控制器所在的文件夹名称，顶级菜单必填</i>）<span id="msg"></span></td>
      </tr>
      <tr>
        <td>访问URL<span class="red">*</span></td>
        <td><input type="text" name="option_value" value="<?php echo set_value('option_value'); ?>" class="ws50"/>由控制器、方法组成<?php echo form_error('option_value');?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="option_sort" value="<?php echo set_value('option_sort',10); ?>" class="ws50" />
          <?php echo form_error('option_sort');?></td>
      </tr>
      <tr>
        <td>描述</td>
        <td><textarea name="option_desc" class="ws50" placeholder="最大可输入200个字符"></textarea></td>
      </tr>
      <tr>
        <td></td>
